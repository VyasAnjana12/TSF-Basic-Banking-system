...
<html lang="en">
    <head>
        ...
        <link href="spark.css" rel="stylesheet" />
        <style>
  ...
  alert("Payment Successful !!");
    ...
    <body id="page-top">
        <nav class="navbar navbar-expand-lg navbar-light fixed-top " id="mainNav">
            <div class="container">
                <a class="text-primary navbar-brand mr-auto" href="sparkindex.html"><img src="img/logo.png" height="30" width="41">Basic Bank</a> 
                ...
                <div class=" collapse navbar-collapse" id="navbarResponsive">
                    <ul class=" navbar-nav ml-auto">
                        <li class="nav-item"><a class="text-primary nav-link js-scroll-trigger" href="sparkindex.html">Home</a></li>
                        <li class="nav-item"><a class="text-primary nav-link js-scroll-trigger" href="sparkpayment.php">Payment</a></li>
                        <li class="nav-item"><a class="text-primary nav-link js-scroll-trigger" href="sparkcustomer.html">Client</a></li>     
                </div>
            </div>
        </nav>
        <?php
...
?>
    ...
    <div class="container">
      ...
      <form action="/bank/sparkpayment.php">
        <div class="row">
          <div class="col-50">
            <h3>Transfer To:</h3>
            ...
            <label for="money"><i class="fas fa-dollar-sign"></i> Money Rs</label>
